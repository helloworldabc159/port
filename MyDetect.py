...
from utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadStreams, LoadImages_Old
...
def detect(img):
    # Dataloader
    # 载入数据
    dataset = LoadImages_Old(img, img_size=imgsz, stride=stride, auto=pt)
...
# path = r'D:\yolov5-master\data\images\bus.jpg'
# img = cv2.imread(path)
# 传入一张图片
# detect(img)