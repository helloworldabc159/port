...
#=====================================================================
        ...
        #
        # # 检查是否有分割结果
        # if results and hasattr(results[0], 'masks') and results[0].masks.data.shape[0] > 0:
        #     masksxy = results[0].masks.xy
        #     print(img.shape)
        #
        #     # 创建一个空的掩膜，数据类型改为 uint8
        ...
        #
        #         # 过滤并提取船尾平面点云
        #         raw_points = np.asarray(colored_cloud.points)  # 使用过滤后的点云
        #         tail_point_cloud = o3d.geometry.PointCloud()
        #
        #         after_filter = np.logical_and.reduce([
        #             a * raw_points[:, 0] + b * raw_points[:, 1] + c * raw_points[:, 2] + d >= -0.3,
...
if __name__ == '__main__':
    ...
    pcd_folder = r"C:\Users\Yang Yuhao\Desktop\找点云工作\2023-04-02\pcd"
    image_folder = r"C:\Users\Yang Yuhao\Desktop\找点云工作\2023-04-02\img"
    # pcd_folder = r"C:\Users\huangzhifei\Desktop\pcd\pcd"
    # image_folder = r"C:\Users\huangzhifei\Desktop\pcd\picture"
