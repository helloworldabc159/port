...
# # ------------------------------------------------------语义分割-----------------------------------
        ...
        print(time.time())
        # 6. 再次拟合船尾平面
        plane_model, inliers = tail_point_cloud.segment_plane(distance_threshold=0.25, ransac_n=3, num_iterations=100000)
        print(time.time())
        [a, b, c, d] = plane_model
        print("船尾面平面方程参数:")
        # logger.info(f"识别结果：{detections}")
...
if __name__ == '__main__':
    ...
    pcd_folder = r"C:\Users\Yang Yuhao\Desktop\10月28数据处理\pcds"
    image_folder= r"C:\Users\Yang Yuhao\Desktop\10月28数据处理\imgs"
