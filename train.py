...
"""
#  python train.py --img 640 --weights yolov5s.pt --worker 0 --device 0 --data data/boxdata.yaml
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    last, best = w / 'last.pt', w / 'HHG_intensity.pt'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/boxdata.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--image-weights', action='store_true', help='use weighted images selection for training')
