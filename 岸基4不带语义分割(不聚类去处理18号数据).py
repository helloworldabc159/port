...
# 创建文件处理器，使用追加模式
file_handler = logging.FileHandler('新025第五跑.log', mode='a',encoding='utf-8')
...
def call_back(pcd, img, index):
    try:
        ...
        [
            # points[:, 0] >= 0, points[:, 0] <= 100,  # 水平方向过滤
...
# # ------------------------------------------------------语义分割-----------------------------------
        # ---------------------------------------拟合-----------------------------------------------------
        print(time.time())
        plane_model, inliers = colored_cloud.segment_plane(distance_threshold=0.3, ransac_n=3, num_iterations=100000)
        print(time.time())
        [a, b, c, d] = plane_model
        print("YOLO识别面方程参数:")
        ...
        after_filter = np.logical_and.reduce([
            a * raw_points[:, 0] + b * raw_points[:, 1] + c * raw_points[:, 2] + d >= -0.4,
...
if __name__ == '__main__':
    ...
    pcd_folder = r"C:\Users\Yang Yuhao\Desktop\找点云工作\2024-10-07-08新点云文件\lidar\20241018"
    image_folder= r"C:\Users\Yang Yuhao\Desktop\找点云工作\2024-10-07-08新点云文件\imgs\20241018"
