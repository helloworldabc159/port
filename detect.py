...
# python detect.py --weights runs/train/exp13/weights/HHG_intensity.pt --source E:\Pointnet_Pointnet2_pytorch-master\test1.png
...
def run(
        ...
        line_thickness=1,  # bounding box thickness (pixels)  改变bbox的边框粗细
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp5/weights/HHG_intensity.pt', help='model path or triton URL')
